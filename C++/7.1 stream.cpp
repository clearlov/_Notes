...
/**
 * "Vince" into non-buffer, "Well" into buffer
 */
cin >> carbohydrate;  //input  "  Vince Well", 
cout << carbohydrate;  // output "Vince"

/**
 * cin.getline(char *pstr, int n, char delim)
 */
cin.getline(carbohydrate, 50, '#');  // input "  Vince Well#Love"
 ...
 */
cout << carbohydrate << endl;  // output "  Vince Well"
